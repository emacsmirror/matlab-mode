...
You can create a temorary home by setting the the environment variable, HOME set to a temporary
...
If using Emacs 30 or later you need to [[file:install-matlab-tree-sitter-grammar.org][install the MATLAB tree-sitter grammar]]. This is needed for the tests.
