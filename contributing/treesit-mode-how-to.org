...
Create /tests/test-LANUGAGE-ts-mode-file-encoding-files/*.LANG files containing corrupted
...
If the =./tests/test-LANUGAGE-ts-mode-file-encoding-files/NAME*_expected.txt~= files look good
rename them to =./tests/test-LANUGAGE-ts-mode-file-encoding-files/NAME*_expected.txt= (per the
