;;; test-matlab-ts-mode-imenu-create-index-function.el --- -*- lexical-binding: t -*-
;;
...
(defvar test-matlab-ts-mode-imenu-create-index-function--file nil)

(defun test-matlab-ts-mode-imenu-create-index-function--file (m-file)
...
Using ./test-matlab-ts-mode-imenu-create-index-function-files/NAME.m, compare imenu results
against ./test-matlab-ts-mode-imenu-create-index-function-files/NAME_expected.txt.  This loops
on all ./test-matlab-ts-mode-imenu-create-index-function-files/NAME.m files.

To add a test, create
  ./test-matlab-ts-mode-imenu-create-index-function-files/NAME.m
and run this function.  The baseline is saved for you as
  ./test-matlab-ts-mode-imenu-create-index-function-files/NAME_expected.txt~
...
(provide 'test-matlab-ts-mode-imenu-create-index-function)
;;; test-matlab-ts-mode-imenu-create-index-function.el ends here
