...
- Invoking      : "M-q" = matlab-ts-mode-prog-fill-reindent-defun
  Start point   :  586
  Moved to point:  561
  : 25:4:     b = "a long string a long string a long string a long string a long string a long string a long string a long string a long string a long string a long string a long string a long string a long string ";
  :           ^
  Buffer modified:
  #+begin_src diff
--- start_contents
