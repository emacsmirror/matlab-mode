...
function [a1, a2, a3, a4, long_variable_a] = indent_cell %  <{Matched rule: (matlab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
    ...
    c1 = {char([0xD800 0xDC32 0xD800 0xDC00 0xD800 0xDC1C]); %  <{Matched rule: ((parent-is "\\`block\\'") parent 0)}>
          char([0xD800 0xDF3E 0xD800 0xDF48]); %  <{Matched rule: (matlab-ts-mode--i-row-matcher matlab-ts-mode--i-row-matcher-anchor matlab-ts-mode--i-row-matcher-offset)}>
          char([0xD802 0xDC11 0xD802 0xDC2C]); %  <{Matched rule: (matlab-ts-mode--i-row-matcher matlab-ts-mode--i-row-matcher-anchor matlab-ts-mode--i-row-matcher-offset)}>
          char([0xD83D 0xDE08 0xD83D 0xDE31 0xD83D 0xDE49])}; %  <{Matched rule: (matlab-ts-mode--i-row-matcher matlab-ts-mode--i-row-matcher-anchor matlab-ts-mode--i-row-matcher-offset)}>
