...
% See: https://github.com/acristoffers/tree-sitter-matlab/issues/134 %  <{Matched rule: (matlab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>

classdef indent_ellipsis_between_classdef_blocks_issue134 %  <{Matched rule: (matlab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
    ...
    ... %  <{Matched rule: ((parent-is "\\`class_definition\\'") parent 4)}>
