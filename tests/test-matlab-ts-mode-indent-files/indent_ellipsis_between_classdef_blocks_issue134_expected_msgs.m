...
% See: https://github.com/acristoffers/tree-sitter-matlab/issues/134 %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>

classdef indent_ellipsis_between_classdef_blocks_issue134 %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
