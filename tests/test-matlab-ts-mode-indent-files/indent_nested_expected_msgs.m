...
% t-utils-test-indent: no-line-by-line-indent - nested functions require an end %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>

function b = indent_nested(a) %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
