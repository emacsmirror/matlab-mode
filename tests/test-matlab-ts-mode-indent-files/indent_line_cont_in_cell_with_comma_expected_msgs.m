...
% t-utils-test-indent: no-line-by-line-indent - "} ..." is not handled correctly %  <{Matched rule: (matlab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
...
function someFcn(varargin) %  <{Matched rule: (matlab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
