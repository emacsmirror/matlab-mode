...
myMatrix = [ %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
...
disp(myMatrix(1:  ... %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
              end)); %  <{Matched rule: ((parent-is "\\`range\\'") parent 0)}>

disp(myMatrix(1: (1 + ... %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
