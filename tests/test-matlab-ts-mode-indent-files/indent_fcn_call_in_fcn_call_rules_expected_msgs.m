...
% Here MATLAB indent "SomeLongString" to be 4 from the '(' in "someFunction1(" %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
...
something.foo = someFunction1(someFunction2( ... %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
                                  "SomeLongString")); %  <{Matched rule: ((node-is "\\`arguments\\'") parent 4)}>

% Here MATLAB indents similar to the prior. %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
...
% *** Conclusion *** %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
...
% --- Test unnecessary spaces --- %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
...
% --- Test namespaces --- %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>

something.foo = fooNamespace.someFunction1(fooNamespace.someFunction2( ... %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
...
% --- Test namespaces with unnecessary spaces %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
