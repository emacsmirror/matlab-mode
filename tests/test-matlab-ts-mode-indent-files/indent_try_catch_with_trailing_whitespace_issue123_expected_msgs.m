...
% https://github.com/acristoffers/tree-sitter-matlab/issues/123 %  <{Matched rule: (matlab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>

% Below the "catch ME  " should have trailing whitespace to exercise tree-sitter %  <{Matched rule: (matlab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>

classdef indent_try_catch_with_trailing_whitespace_issue123 %  <{Matched rule: (matlab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
