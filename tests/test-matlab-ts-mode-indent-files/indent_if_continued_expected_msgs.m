...
% t-utils-test-indent: no-line-by-line-indent - continued "fcn_call(arg1, ..." %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
...
function indent_if_continued %  <{Matched rule: (maltab-ts-mode--i-top-level matlab-ts-mode--column-0 0)}>
