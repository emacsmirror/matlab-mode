...
% the indent-region of the matrix in the temporary buffer doesn't pickup invalid content. %  <{Matched rule: (matlab-ts-mode--i-block-comment-end-matcher matlab-ts-mode--i-block-comment-end-anchor 0)}>
